...
class Sampler(nn.Module):
    ...
    def _attach_sampling_mask_to_output(
        ...
        # The filters retain a probability-sorted prefix. Copy its rectangular
        # backing storage and reserve one guard column for a sampled token that
        # backend numerics place just outside the reconstructed support.
