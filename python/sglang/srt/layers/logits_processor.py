...
class LogitsProcessorOutput:
    ...
    # truncation/renormalization. Kept as padded device tensors until the
    # scheduler processes the completed result, so sampling does not block on
    # GPU-to-CPU conversion. Only populated when requested.
