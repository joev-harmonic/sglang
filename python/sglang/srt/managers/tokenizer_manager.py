...
class TokenizerManager(TokenizerControlMixin, TokenizerManagerScoreMixin):
    ...
    def __init__(
        ...
        *,
        ...
        # In a tokenizer-worker process this is the process's first publish; on
        # the in-process path the launcher published this same record already, so
        # this is a no-op rather than a re-projection.
