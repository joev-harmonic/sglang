...
def test_sampling_mask_is_packed_as_device_tensors():
    ...
    # The method is intentionally independent of Sampler instance state so it
    # can later be shared by the EAGLE target-verification path.
    ...
    # appended after the two retained candidates entirely on the device.
