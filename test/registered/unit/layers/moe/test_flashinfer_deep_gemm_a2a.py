...
class TestFlashinferDeepGemmA2A(CustomTestCase):
    ...
    def test_source_rank_geometry(self):
    ...
    def test_dispatch_index_marks_padding_invalid(self):
    ...
    def test_global_expert_mapping(self):
